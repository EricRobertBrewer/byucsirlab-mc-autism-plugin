    ...
    public static void saveBeforeShutDown(File dataFolder){
        ...
        try {
            ...
            for(Game i : IncermentPlayTime.roleplay_analyse){
                fr.write("Player: " + i.getPlayerName() + "\tTime Started: " + i.getEnterTime() + "\tTime Elapsed: " + i.getTimeElapsed()+ "\r\n");
            }
            ...
            for(Game i : IncermentPlayTime.other_games){
                fr.write("Player: " + i.getPlayerName() + "\tTime Started: " + i.getEnterTime()+ "\tGame: " + i.getGameName() + "\tTime Elapsed: " + i.getTimeElapsed() + "\r\n");
            }

            fr.write("Still in the game: (" + IncermentPlayTime.playersInGame.size() + " times)\r\n");
            for(Game i : IncermentPlayTime.playersInGame){
                fr.write("Player: " + i.getPlayerName() + "\tTime Started: " + i.getEnterTime()+ "\tGame: " + i.getGameName() + "\tEntered time: " + i.getEnterTime() + "\r\n");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }finally{
